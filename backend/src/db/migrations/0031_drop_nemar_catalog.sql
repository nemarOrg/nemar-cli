...
-- (owner_user_id = -1) by migration 0028. Reads (list, search, page-bundle)
...
-- lost (it is in `datasets`); re-running migrations 0027/0028 rebuilds the
...
-- present -- DROP TABLE datasets_fts, export, then recreate from 0029.
