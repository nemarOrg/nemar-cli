 ...
 * harmless (clients ignore unparseable values) and lets the file route
 * stay 200 over a manifest with a malformed `created` field instead of
 * crashing. Already-HTTP-date input passes through (defensive against
 * a caller that did the conversion once already).
 */
