 ...
 *
 * The services/github/* modules are intentionally D1-free: `ensureRepoToSpec`
 * (github/branch-protection.ts) and `reconcileCollaborators`
 * (github/collaborators.ts) take the resolved owner + writer GitHub logins.
