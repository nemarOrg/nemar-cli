...
| [draft-anonymous-deposit-analysis.md](draft-anonymous-deposit-analysis.md) | Analysis of pseudonymous deposit for double-blind review: the leak inventory, and what each candidate design requires. No decision taken. | public |
