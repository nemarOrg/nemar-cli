...
> Outcomes of these prototypes live in [validated workflows](https://docs.nemar.org/admin/operations/validated-workflows/).


> **STATUS: HISTORICAL.** Prototype scripts from the January 2026 design spike. Their *outcomes* are in [validated workflows](https://docs.nemar.org/admin/operations/validated-workflows/); the protection payloads shown here are the pre-#713 ones and are wrong today.
