...
| `nemar admin fleet` | drift, enforce, revalidate — governance across dataset repos (epic #713); key-registration — re-register content S3 holds but the location log never recorded (#1392) |
